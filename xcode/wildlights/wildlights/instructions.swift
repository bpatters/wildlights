...
//
class Instructions {
    static let INST_END          = 0x00
    static let INST_DELAY        = 0x01
    static let INST_UPDATE       = 0x02
    static let INST_PUSHC_I      = 0x03
    static let INST_PULLC_I      = 0x04
    static let INST_PUSH_LERP_I  = 0x05
    static let INST_PULL_LERP_I  = 0x06
}
