...
class ProgramsViewController: UICollectionViewController {
    
    let programsCell = "programsCell"
    var programs : [LedProgram] = []
    ...
    func newProgramAction() {
        performSegueWithIdentifier("newProgram", sender: self)
    }
